    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-4">
                <a href="{{ route('characters.index') }}" class="text-gray-600 hover:text-gray-800">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                    </svg>
                </a>
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Criar Novo Personagem</h1>
                    <p class="mt-2 text-gray-600">Preencha as informações do seu personagem</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md border border-gray-200">
            <form action="{{ route('characters.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <textarea name="summary" id="summary" rows="3" 
                              ...
                              placeholder="Uma breve descrição do personagem, classe, raça, etc.">{{ old('summary') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="backstory" id="backstory" rows="6" 
                              ...
                              placeholder="Conte a história de fundo do seu personagem, sua origem, motivações, etc.">{{ old('backstory') }}</textarea>
                ...
                @if($campaigns->count() > 0)
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                            Participar de Campanhas (Opcional)
                        </label>
                        <div class="space-y-3">
                ...
                <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                    <a href="{{ route('characters.index') }}" class="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50">
                        Cancelar
                    </a>
